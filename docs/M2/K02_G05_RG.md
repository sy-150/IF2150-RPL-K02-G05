...
| R07 | A01 | *System* | Sistem harus melakukan enskripsi terhadap data autentikasi pengguna petugas kebersihan. | Ya |
| R08 | A01 | *System* | Sistem harus menerapkan *role-based access* sehingga hanya petugas kebersihan yang memiliki hak akses untuk mengubah jadwal. | Ya |
| R09 | A02 | *System* | Sistem harus menggunakan sistem CRUD pada basis data untuk menyimpan dan memperbarui data jadwal pengambilan sampah yang dikelola petugas kebersihan sampah. | Ya |
| R10 | A01 | *Legal* | Data pribadi pengguna petugas kebersihan harus dijaga sesuai UU No. 27 Tahun 2022. | Tidak |
| R11 | A01 | *Legal* | Hanya petugas kebersihan yang telah terdaftar yang dapat mengakses fitur pengelolaan jadwal. | Tidak |
