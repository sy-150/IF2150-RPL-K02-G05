...
| :--- | :--- | :--- | :--- | :--- |
| R01 | A01 | *User* | Pengguna (masyarakat umum) dapat melakukan pemindaian jenis sampah menggunakan kamera gawai. | Ya |
| R02 | A01 | *User* | Pengguna (masyarakat umum) dapat melihat informasi mengenai jenis sampah dan metode daur ulang yang sesuai setelah melakukan pemindaian. | Ya |
| R03 | A01 | *User* | Pengguna (masyarakat umum) dapat melihat jadwal pembuangan sampah. | Ya |
| R04 | A02 | *User* | Pengguna (petugas kebersihan) dapat menambah atau mengubah jadwal pengambilan sampah. | Ya |
| R05 | A01 | *System* | Sistem harus mengintegrasikan *computer vision*. | Ya |
| R06 | A02 | *System* | Sistem harus mengaplikasikan algoritma *search* | Ya |
| R06 | A02 | *System* | Sistem harus melakukan enskripsi terhadap data autentikasi pengguna petugas kebersihan. | Ya |
| R07 | A02 | *System* | Sistem harus menerapkan *role-based access* sehingga hanya petugas kebersihan yang memiliki hak akses untuk mengubah jadwal. | Ya |
...
| R09 | A02 | *Legal* | Data pribadi pengguna petugas kebersihan harus dijaga sesuai UU No. 27 Tahun 2022. | Tidak |
| R10 | A02 | *Legal* | Hanya petugas kebersihan yang telah terdaftar yang dapat mengakses fitur pengelolaan jadwal. | Tidak |
