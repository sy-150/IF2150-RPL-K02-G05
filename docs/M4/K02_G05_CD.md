...
| :--- | :--- | :--- | :--- |
| *C01* | *Akun Petugas* | *Username, password* | *validasiUsername(), validasiPassword()* |
| *C02* | *Akun Petugas Controller* | *statusLogin* | *prosesLogin(), cekUsername(), cekPassword()* |
| *C03* | *Akun Petugas Interface* | *usernameField, passwordField, pesanStatus* | *showTampilan(), showLogin(), showPesan()* |
