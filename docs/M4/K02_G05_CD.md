...
| *C02* | *Jadwal* | *Menyimpan data jadwal pengambilan sampah.* |
...
| :--- | :--- | :--- | :--- |
| *C01* | *Petugas* | *idPetugas, nama, areaTugas* | *login(), logout(), (kira2 ada yg perlu ditambah ga?)* |
| *C02* | *Jadwal | *idJadwal, tanggalJadwal, waktuPengambilan, areaPengambilan, statusPengambilan (kira2 perlu ga misal jadwal ga sesuai?)* | *validasiJadwal(), getDetailJadwal()* |
| *C06* | *LayarPetugas* | *formInput* | *inputJadwal(), submitJadwal()* |
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC06-class-diagram.png" width="70%">
</p>
<p align="center">
